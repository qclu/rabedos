...
type rbdlogger struct {
	lb *logBean
}

func (this *rbdlogger) SetConsole(isConsole bool) {
	this.lb.setConsole(isConsole)
}

func (this *rbdlogger) SetLevel(_level LogLvlT) {
	this.lb.setLevel(_level)
}

func (this *rbdlogger) SetFormat(logFormat string) {
	this.lb.setFormat(logFormat)
}

func (this *rbdlogger) SetRollingFile(fileDir, fileName string, maxNumber int32, maxSize int64, _unit UNIT) {
	this.lb.setRollingFile(fileDir, fileName, maxNumber, maxSize, _unit)
}

func (this *rbdlogger) SetRollingDaily(fileDir, fileName string) {
	this.lb.setRollingDaily(fileDir, fileName)
}

func (this *rbdlogger) Debug(v ...interface{}) {
	this.lb.debug(v...)
}
func (this *rbdlogger) Info(v ...interface{}) {
	this.lb.info(v...)
}
func (this *rbdlogger) Warn(v ...interface{}) {
	this.lb.warn(v...)
}
func (this *rbdlogger) Error(v ...interface{}) {
	this.lb.error(v...)
}
func (this *rbdlogger) Fatal(v ...interface{}) {
	this.lb.fatal(v...)
}

func (this *rbdlogger) SetLevelFile(level LogLvlT, dir, fileName string) {
...
func (this *logBean) setLevelFile(level LogLvlT, dir, fileName string) {
...
func (this *logBean) setLevel(_level LogLvlT) {
...
func (this *logBean) setRollingFile(fileDir, fileName string, maxNumber int32, maxSize int64, _unit UNIT) (err error) {
	this.mu.Lock()
	defer this.mu.Unlock()
	if maxNumber > 0 {
...
func (this *logBean) log(level string, v ...interface{}) {
	...
	if lg != nil {
		...
		if this.logLevel <= _level {
			if lg != nil {
				if this.format == "" {
					lg.write(_level_lb, s)
				} else {
					lg.writef(this.format, vs...)
				}
			}
			this.console(vs...)
		}
...
func (this *fileBean) rename(rolltype LogRollT) {
	this.mu.Lock()
	defer this.mu.Unlock()
	this.close()
	nextfilename := ""
	switch rolltype {
	case RT_DAILY:
		nextfilename = fmt.Sprint(this.dir, "/", this.filename, ".", this._date.Format(DATEFORMAT))
	case RT_SIZE:
